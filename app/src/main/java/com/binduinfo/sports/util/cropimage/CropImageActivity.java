...
public class CropImageActivity extends BaseActivity
    ...
    private ImageView selectImageView, cropImageRotate, closeImage;
...
//        getSupportActionBar().show();
        ...
        selectImageView = findViewById(R.id.click_tool_bar);
        cropImageRotate = findViewById(R.id.image_rotate);
        closeImage = findViewById(R.id.crop_close);
        ...
        cropImageRotate.setOnClickListener(v -> {
