...
package com.binduinfo.sports.util.cropimage;
...
public final class CropImage {
    ...
    public static final int CROP_DRIVER_PROFILE_PIC = 1200;


    public static final int CROP_DRIVER_LICENCE_FRONT = 1000;

    public static final int CROP_DRIVER_LICENCE_BACK = 10001;
    ...
    public static final class ActivityBuilder {
        ...
        public void start(@NonNull Activity activity, int requestCode) {
            mOptions.validate();
            activity.startActivityForResult(getIntent(activity), requestCode);//CROP_IMAGE_ACTIVITY_REQUEST_CODE
        }
